...
if(userStore.user_is_show && userStore.userAddress.indexOf('上海') !=-1) {
    ...
    <div v-loading="loading">
      <div class="app-header-box">
        ...
        <div class="app-header-input">
          ...
          <Input v-if="!userStore.userIsLogin && userStore.user_is_show" @getPlay="getDownUrl" :loading="loading" :time="limitTimer.time"/>
      ...
      <div v-if="userStore.userAddress.indexOf('上海') == -1 && userStore.user_is_show" class="app-web-list" v-loading="listLoading">
