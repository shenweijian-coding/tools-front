<template>
  <s-dialog v-model:visible="visible" width="500px" title="权限不足" @close="close">
    <p style="line-height: 30px;">您可以选择如下方式获取权限<br>
    ...
    <a-divider></a-divider>
    <p style="font-size:12px;color: #919499">充值费用将用于对接新素材网站及网站运营成本，感谢您的支持</p>
  </s-dialog>
</template>
